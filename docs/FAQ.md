...
- [FAQ](#faq)
  ...
  - [When using the Arduino IDE development platform, how to read the MAC address of the Wi-Fi that comes with ESP32?](#when-using-the-arduino-ide-development-platform-how-to-read-the-mac-address-of-the-wi-fi-that-comes-with-esp32)
  - [How to use the flash download tool to flash the bin file generated by Arduino to ESP32?](#how-to-use-the-flash-download-tool-to-flash-the-bin-file-generated-by-arduino-to-esp32)
  - [How to update the esp32-arduino library version?](#how-to-update-the-esp32-arduino-library-version)
