...
static const uint8_t gc9503v_type0_init_operations[] = {
    BEGIN_WRITE,
  ...
  //  WRITE_BYTES, 3, 0x04, 0x03, 0x66,
    ...
    WRITE_BYTES, 4, 0x99, 0xa3, 0xa3, 0x51,//checked1

    WRITE_C8_D8, 0xA3, 0xEE,

    WRITE_COMMAND_8, 0xFD,
    WRITE_BYTES, 3, 0x3c, 0x3c, 0x00,

   
    WRITE_C8_D8, 0x71, 0x48,
    WRITE_C8_D8, 0x72, 0x48,

    WRITE_C8_D16, 0x73, 0x00, 0x44, //checked2
    ...
    WRITE_C8_D8, 0xB1, 0x10, //checked3
...
static const uint8_t st7701_type0_init_operations[] = {
    BEGIN_WRITE,
    WRITE_COMMAND_8, 0x11,
    WRITE_BYTES, 1, 0x00,
    DELAY, 500,
